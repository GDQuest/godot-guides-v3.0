...
.. figure:: ./img/ui_gui_step_tutorial_containers_structure.png
   :alt: We get a clean UI layout with only 4 containers
...
.. figure:: ./img/ui_gui_containers_structure_in_godot.png
   :alt: You should have 4 containers that look like this
...
.. figure:: ./img/ui_gui_step_tutorial_bar_template_1.png
   :alt: Your scene tree should look like this. We're ready to throw in
   some textures
...
.. figure:: ./img/ui_gui_step_tutorial_textures_in_FileSystem_tab.png
   :alt: You should see a list of textures that we'll use to skin our
   interface.
...
.. figure:: ./img/ui_gui_step_tutorial_bar_label_stacked.png
   :alt: If you select both nodes, you should see something like this
...
.. figure:: ./img/ui_gui_step_tutorial_bar_nesting_inside_background.png
   :alt: By using the Background node as the two textures' parent, we
   take control away from the Count MarginContainer
...
.. figure:: ./img/ui_gui_step_tutorial_bar_placed_title_and_label.png
   :alt: Here's how the nodes' bounding boxes should look in the
   viewport. Keep it rough, you don't need to place them too precisely
   for now.
...
.. figure:: ./img/ui_gui_step_tutorial_number_baseline.png
   :alt: With a Bottom value of 2 pixels, the Number aligns with the
   Title
...
.. figure:: ./img/ui_gui_step_tutorial_bar_final.png
   :alt: That's it, our life bar is ready. This last part was quick,
   wasn't it? That's thanks to our robust container setup.
...
.. figure:: ./img/ui_gui_step_tutorial_counter_design_1.png
   :alt: Here's how your node tree should look so far
...
.. figure:: ./img/ui_gui_step_tutorial_counter_design_2.png
   :alt: The nodes anchor to the entire Background, but their position
   is off
...
.. figure:: ./img/ui_gui_step_tutorial_counter_design_3.png
   :alt: The Number node aligned to the left and centre
...
.. figure:: ./img/ui_gui_step_tutorial_counter_design_4.png
   :alt: The bomb icon anchors to the Background's right edge. Resize
   the Counter container to see the Icon node stick to its right side
...
.. figure:: ./img/ui_gui_step_tutorial_counter_design_5.png
   :alt: An expanding container eats all the space it can from its
   parent, pushing everything else along the way
...
.. figure:: ./img/ui_gui_step_tutorial_bar_template_scene.png
   :alt: With no extra changes, our Bar is ready to use
...
.. figure:: img/gui_step_tutorial_gui_scene_hierarchy.png
   :alt: Inherited scenes help us keep the GUI scene clean. In the end,
   we will only have containers and one node for each UI component.
...
.. figure:: img/ui_gui_step_tutorial_inherited_scene_parent.png
   :alt: You can't rename grey nodes. This tells you they have a parent
   scene
...
.. figure:: ./img/ui_gui_step_tutorial_design_EnergyBar_1.png
   :alt: If we change the font resource, all the nodes that use it are
   affected
...
.. figure:: ./img/ui_gui_step_tutorial_design_EnergyBar_2.png
   :alt: Use this option to create unique copies of the resources for
   one node
...
.. figure:: ./img/ui_gui_step_tutorial_design_EnergyBar_3.png
   :alt: The EP Count widget, with a smaller font than its HP
   counterpart
...
.. figure:: ./img/ui_gui_step_tutorial_design_EnergyBar_4.png
   :alt: The Count looks better now it's a bit smaller
...
.. figure:: ./img/ui_gui_step_tutorial_design_counters_1.png
   :alt: The bomb counter is the same as the original Counter scene
...
.. figure:: ./img/ui_gui_step_tutorial_design_counters_2.png
   :alt: The rupee counter should look about like this
...
.. figure:: ./img/ui_gui_step_tutorial_assemble_final_gui_1.png
   :alt: The LifeBar and the EnergyBar align automatically
...
.. figure:: ./img/ui_gui_step_tutorial_assemble_final_gui_2.png
   :alt: The nodes resize to take all the available vertical space
...
.. figure:: ./img/ui_gui_step_tutorial_assemble_final_gui_3.png
   :alt: Now both counters have a decent size
...
.. figure:: ./img/ui_gui_step_tutorial_assemble_final_gui_4.png
   :alt: The 2 bars align perfectly
