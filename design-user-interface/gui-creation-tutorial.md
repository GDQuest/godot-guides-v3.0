...
There two possible approaches to the GUI: we can design elements in separate scenes and put them together, or prototype everything in a single scene and break it down later. I recommend to work with a single scene as you can play with your UI's placement and proportions faster this way. Once it looks good, it's easy to save entire sections of the node tree as reusable sub-scenes. We'll do just that in a moment.
